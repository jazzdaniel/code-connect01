...
export const SearchIllustration = (p: IllustrationProps) => (
  <svg width={96} height={96} viewBox="0 0 96 96" fill="none" {...p}>
    <circle cx="48" cy="48" r="48" fill="var(--color-brand-50)" />
    <circle cx="43" cy="43" r="18" stroke="var(--color-brand-500)" strokeWidth="4" />
    <path d="m57 57 12 12" stroke="var(--color-brand-500)" strokeWidth="4" strokeLinecap="round" />
    <path d="M35 43h16M43 35v16" stroke="var(--color-brand-100)" strokeWidth="4" strokeLinecap="round" />
  </svg>
)
...
export const ErrorIllustration = (p: IllustrationProps) => (
  <svg width={96} height={96} viewBox="0 0 96 96" fill="none" {...p}>
    <circle cx="48" cy="48" r="48" fill="var(--color-danger-50)" />
    <path d="M48 24l24 42H24l24-42Z" fill="var(--color-neutral-0)" stroke="var(--color-danger-500)" strokeWidth="4" strokeLinejoin="round" />
    <path d="M48 40v12" stroke="var(--color-danger-500)" strokeWidth="4" strokeLinecap="round" />
    <circle cx="48" cy="58" r="2.5" fill="var(--color-danger-500)" />
  </svg>
)
